...
const Index = () => {
  ...
  }, [st_eventCreateDone, router.query]);
  ...
  }, [st_eventUpdateDone, router.query]);
  ...
  }, [st_eventDeleteDone, router.query]);

  useEffect(() => {
    if (st_eventListError) {
      return message.error(st_eventListError);
    }
  }, [st_eventListError]);
        ...
        <Row gutter={[10, 10]} style={{ padding: "0 0 10px 0" }}>
          ...
          <Col>
            <Button
              onClick={() =>
                moveLinkHandler(
                  `/admin/event?page=${currentPage}&search=${inputSearch.value}`
                )
              }
            >
              <SearchOutlined />
